		...
		<Card class="mt-6 w-full" padding="xl" size="md">
			<form method="POST" class="flex flex-col space-y-6" use:enhance>
				<label class="space-y-2" for="full_name">
					...
					{#if $errors.full_name}
						<span class="text-red-600 dark:text-red-500 text-sm">{$errors.full_name}</span>
					{/if}
				</label>
				<label class="space-y-2" for="email">
					...
					{#if $errors.email}
						<span class="text-red-600 dark:text-red-500 text-sm">{$errors.email}</span>
					{/if}
				</label>
				<label class="space-y-2" for="password">
					...
					{#if $errors.password}
						<span class="text-red-600 dark:text-red-500 text-sm">{$errors.password}</span>
					{/if}
				</label>
				<label class="space-y-2" for="passwordConfirm">
					...
					{#if $errors.passwordConfirm}
						<span class="text-red-600 dark:text-red-500 text-sm">{$errors.passwordConfirm}</span>
					{/if}
				</label>
